...
export async function render() {
  ...
  page.innerHTML = `
    ...
    <div id="version-bar" style="visibility: hidden;"><div class="stat-card loading-placeholder" style="height:80px;margin-bottom:var(--space-lg)"></div></div>
    <div id="services-list"><div class="stat-card loading-placeholder" style="height:64px"></div></div>
    <div class="config-section" id="docker-manager-section" style="visibility: hidden;">
