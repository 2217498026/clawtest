...
export default {
  ...
  loadFailedHint: _('可能需要更新 智能体 到 2026.3.11+ 以支持 Usage API', 'You may need to update 智能体 to 2026.3.11+ for Usage API support', '可能需要更新 智能体 到 2026.3.11+ 以支援 Usage API'),
  retry: _('重试', 'Retry', '重試'),
