...
export default {
  ...
  qqbotGuideFooter: _('<div style="margin-top:8px;font-size:var(--font-size-xs);color:var(--text-tertiary)">遇到问题？参考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">智能体 × QQ 常见问题</a></div>', '<div style="margin-top:8px;font-size:var(--font-size-xs);color:var(--text-tertiary)">遇到问题？参考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">智能体 × QQ 常见问题</a></div>', '<div style="margin-top:8px;font-size:var(--font-size-xs);color:var(--text-tertiary)">遇到問題？參考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">智能体 × QQ 常见問題</a></div>'),
  ...
  qqFaqBtn: _('打开 QQ 智能体 常见问题', 'Open QQ 智能体 FAQ', '開啟 QQ 智能体 常见問題'),
  ...
  qqDiagHint: _('检查<strong>已保存到配置文件</strong>的凭证、本机 Gateway 端口、<code>/__api/health</code>、QQ 插件与 chatCompletions。QQ 提示「灵魂不在线」时优先看此处，并参考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">智能体 × QQ 常见问题</a>。', '检查<strong>已保存到配置文件</strong>的凭证、本机 Gateway 端口、<code>/__api/health</code>、QQ 插件与 chatCompletions。QQ 提示「灵魂不在线」时优先看此处，并参考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">智能体 × QQ 常见问题</a>。', '檢查<strong>已儲存到設定檔案</strong>的憑證、本機 Gateway 連接埠、<code>/__api/health</code>、QQ 外掛與 chatCompletions。QQ 提示「靈魂不線上」時優先看此處，並參考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">智能体 × QQ 常见問題</a>。'),
  ...
  qqVerifyNote: _('此项只验证 AppID/Secret 能否向腾讯换 token。<strong>不能</strong>代表 QQ 里机器人已在线；若提示「灵魂不在线」，请使用下方 <strong>完整联通诊断</strong> 并对照 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">QQ 智能体 常见问题</a>。', '此项只验证 AppID/Secret 能否向腾讯换 token。<strong>不能</strong>代表 QQ 里机器人已在线；若提示「灵魂不在线」，请使用下方 <strong>完整联通诊断</strong> 并对照 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">QQ 智能体 常见问题</a>。', '此項只驗證 AppID/Secret 能否向腾訊換 token。<strong>不能</strong>代表 QQ 里機器人已線上；若提示「靈魂不線上」，請使用下方 <strong>完整聯通诊斷</strong> 並对照 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">QQ 智能体 常见問題</a>。'),
