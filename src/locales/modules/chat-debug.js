...
export default {
  ...
  fixCheckOpenclaw: _('检测 OpenClaw 安装状态...', 'Checking OpenClaw installation...', '檢測 OpenClaw 安裝狀態...', 'OpenClaw インストール状態を確認中...', 'OpenClaw 설치 상태 확인 중...', 'Kiểm tra cài đặt OpenClaw...', 'Comprobando instalación de OpenClaw...', 'Verificando instalação do OpenClaw...', 'Проверка установки OpenClaw...', 'Vérification de l\'installation OpenClaw...', 'OpenClaw-Installation wird überprüft...'),
  fixOpenclawNotInstalled: _('OpenClaw 未安装', 'OpenClaw not installed', 'OpenClaw 未安裝', 'OpenClaw 未インストール', 'OpenClaw 미설치', 'OpenClaw chưa cài đặt', 'OpenClaw no instalado', 'OpenClaw não instalado', 'OpenClaw не установлен', 'OpenClaw non installé', 'OpenClaw nicht installiert'),
  fixScanOpenclawPaths: _('搜索已有 OpenClaw 安装路径...', 'Searching existing OpenClaw installations...', '搜尋已有 OpenClaw 安裝路徑...', '既存の OpenClaw インストールを検索中...', '기존 OpenClaw 설치 검색 중...', 'Đang tìm kiếm cài đặt OpenClaw hiện có...', 'Buscando instalaciones OpenClaw existentes...', 'Procurando instalações OpenClaw existentes...', 'Поиск существующих установок OpenClaw...', 'Recherche des installations OpenClaw existantes...', 'Suche nach vorhandenen OpenClaw-Installationen...'),
  fixOpenclawFoundAt: _('发现已有 OpenClaw 安装', 'Found existing OpenClaw installation', '發現已有 OpenClaw 安裝', '既存の OpenClaw インストールを発見', '기존 OpenClaw 설치 발견됨', 'Đã tìm thấy cài đặt OpenClaw hiện có', 'Instalación OpenClaw existente encontrada', 'Instalação OpenClaw existente encontrada', 'Найдена существующая установка OpenClaw', 'Installation OpenClaw existante trouvée', 'Vorhandene OpenClaw-Installation gefunden'),
  fixOpenclawPathSaved: _('OpenClaw 路径已保存', 'OpenClaw path saved', 'OpenClaw 路徑已儲存', 'OpenClaw パスを保存しました', 'OpenClaw 경로 저장됨', 'Đã lưu đường dẫn OpenClaw', 'Ruta OpenClaw guardada', 'Caminho OpenClaw salvo', 'Путь OpenClaw сохранён', 'Chemin OpenClaw enregistré', 'OpenClaw-Pfad gespeichert'),
  fixTryInstallOpenclaw: _('尝试安装 OpenClaw...', 'Trying to install OpenClaw...', '嘗試安裝 OpenClaw...', 'OpenClaw をインストール試行中...', 'OpenClaw 설치 시도 중...', 'Đang thử cài đặt OpenClaw...', 'Intentando instalar OpenClaw...', 'Tentando instalar OpenClaw...', 'Попытка установить OpenClaw...', 'Tentative d\'installation d\'OpenClaw...', 'OpenClaw wird installiert...'),
  fixOpenclawInstallDone: _('OpenClaw 安装/修复完成', 'OpenClaw install/fix done', 'OpenClaw 安裝/修復完成', 'OpenClaw インストール/修復完了', 'OpenClaw 설치/수리 완료', 'Đã cài đặt/sửa OpenClaw xong', 'Instalación/reparación de OpenClaw completada', 'Instalação/reparo do OpenClaw concluído', 'Установка/исправление OpenClaw завершено', 'Installation/réparation OpenClaw terminée', 'OpenClaw-Installation/Reparatur abgeschlossen'),
  fixBgTaskStarted: _('后台安装任务已启动，请等待完成...', 'Background install task started, please wait...', '後台安裝任務已啟動，請等待完成...'),
  fixOpenclawInstallFail: _('OpenClaw 安装失败', 'OpenClaw install failed', 'OpenClaw 安裝失敗', 'OpenClaw インストール失敗', 'OpenClaw 설치 실패', 'Cài đặt OpenClaw thất bại', 'Instalación de OpenClaw fallida', 'Instalação do OpenClaw falhou', 'Ошибка установки OpenClaw', 'Échec de l\'installation OpenClaw', 'OpenClaw-Installation fehlgeschlagen'),
  fixOpenclawOk: _('OpenClaw 已安装', 'OpenClaw installed', 'OpenClaw 已安裝', 'OpenClaw インストール済み', 'OpenClaw 설치됨', 'OpenClaw đã cài đặt', 'OpenClaw instalado', 'OpenClaw instalado', 'OpenClaw установлен', 'OpenClaw installé', 'OpenClaw installiert'),
