...
export default {
  ...
  openclawReady: _('智能体 就绪', '智能体 Ready', '智能体 就緒'),
  ...
  diagCliNotInstalled: _('智能体 CLI 未安装，请前往「初始设置」页面安装', '智能体 CLI not installed, please go to Setup page to install', '智能体 CLI 未安裝，請前往「初始設定」頁面安裝'),
  ...
  installCorrupt: _('智能体 安装可能已损坏', '智能体 installation may be corrupted', '智能体 安裝可能已損壞'),
  installCorruptHint: _('检测到模块文件缺失，建议前往 <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">关于页面</a> 切换版本或重新安装 智能体 CLI。', 'Module files missing. Go to <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">About page</a> to switch version or reinstall 智能体 CLI.', '檢測到模塊檔案缺失，建議前往 <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">關於頁面</a> 切換版本或重新安裝 智能体 CLI。'),
  installCorruptToast: _('智能体 安装损坏，建议前往「关于」页重新安装', '智能体 installation corrupted, recommend reinstalling from About page', '智能体 安裝損壞，建議前往「關於」頁重新安裝'),
  ...
  cliUnavailable: _('智能体 CLI 不可用', '智能体 CLI unavailable'),
  cliUnavailableHint: _('请前往 <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">关于页面</a> 安装或重新安装 智能体。', 'Please go to <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">About page</a> to install or reinstall 智能体.', '請前往 <a href="#" data-nav="about" style="color:var(--primary);text-decoration:underline;font-weight:500">關於頁面</a> 安裝或重新安裝 智能体。'),
  ...
  fixDone: _('修复完成', 'Fix complete', '修復完成', '修復完了', '수리 완료, 재검사 중', 'Sửa xong, đang quét lại', 'Reparación completa, reescaneando', 'Reparo completo, reverificando', 'Исправление завершено, повторная проверка', 'Réparation terminée, réanalyse', 'Reparatur abgeschlossen, erneuter Scan'),
  ...
  scanCliInstall: _('智能体 安装', '智能体 Installation', '智能体 安裝', '智能体 インストール', '智能体 설치', 'Cài đặt 智能体', 'Instalación de 智能体', 'Instalação do 智能体', 'Установка 智能体', 'Installation 智能体', '智能体-Installation'),
  scanCliMissing: _('未安装 智能体 CLI', '智能体 CLI not installed', '未安裝 智能体 CLI', '智能体 CLI 未インストール', '智能体 CLI 미설치', 'Chưa cài 智能体 CLI', '智能体 CLI no instalado', '智能体 CLI não instalado', '智能体 CLI не установлен', '智能体 CLI non installé', '智能体 CLI nicht installiert'),
  ...
  // 一键修复模态弹框
  fixModalTitle: _('一键修复系统', 'One-Click System Fix', '一鍵修復系統', 'ワンクリックシステム修復', '원클릭 시스템 수리', 'Sửa hệ thống nhanh', 'Reparación rápida del sistema', 'Reparo rápido do sistema', 'Быстрое исправление системы', 'Réparation rapide du système', 'Schnelle Systemreparatur'),
  fixCheckOpenclaw: _('检测 智能体 安装状态...', 'Checking 智能体 installation...', '檢測 智能体 安裝狀態...', '智能体 インストール状態を確認中...', '智能体 설치 상태 확인 중...', 'Kiểm tra cài đặt 智能体...', 'Comprobando instalación de 智能体...', 'Verificando instalação do 智能体...', 'Проверка установки 智能体...', 'Vérification de l\'installation 智能体...', '智能体-Installation wird überprüft...'),
  fixOpenclawNotInstalled: _('智能体 未安装', '智能体 not installed', '智能体 未安裝', '智能体 未インストール', '智能体 미설치', '智能体 chưa cài đặt', '智能体 no instalado', '智能体 não instalado', '智能体 не установлен', '智能体 non installé', '智能体 nicht installiert'),
  fixScanOpenclawPaths: _('搜索已有 智能体 安装路径...', 'Searching existing 智能体 installations...', '搜尋已有 智能体 安裝路徑...', '既存の 智能体 インストールを検索中...', '기존 智能体 설치 검색 중...', 'Đang tìm kiếm cài đặt 智能体 hiện có...', 'Buscando instalaciones 智能体 existentes...', 'Procurando instalações 智能体 existentes...', 'Поиск существующих установок 智能体...', 'Recherche des installations 智能体 existantes...', 'Suche nach vorhandenen 智能体-Installationen...'),
  fixOpenclawFoundAt: _('发现已有 智能体 安装', 'Found existing 智能体 installation', '發現已有 智能体 安裝', '既存の 智能体 インストールを発見', '기존 智能体 설치 발견됨', 'Đã tìm thấy cài đặt 智能体 hiện có', 'Instalación 智能体 existente encontrada', 'Instalação 智能体 existente encontrada', 'Найдена существующая установка 智能体', 'Installation 智能体 existante trouvée', 'Vorhandene 智能体-Installation gefunden'),
  fixOpenclawPathSaved: _('智能体 路径已保存', '智能体 path saved', '智能体 路徑已儲存', '智能体 パスを保存しました', '智能体 경로 저장됨', 'Đã lưu đường dẫn 智能体', 'Ruta 智能体 guardada', 'Caminho 智能体 salvo', 'Путь 智能体 сохранён', 'Chemin 智能体 enregistré', '智能体-Pfad gespeichert'),
  fixTryInstallOpenclaw: _('尝试安装 智能体...', 'Trying to install 智能体...', '嘗試安裝 智能体...', '智能体 をインストール試行中...', '智能体 설치 시도 중...', 'Đang thử cài đặt 智能体...', 'Intentando instalar 智能体...', 'Tentando instalar 智能体...', 'Попытка установить 智能体...', 'Tentative d\'installation d\'智能体...', '智能体 wird installiert...'),
  fixOpenclawInstallDone: _('智能体 安装/修复完成', '智能体 install/fix done', '智能体 安裝/修復完成', '智能体 インストール/修復完了', '智能体 설치/수리 완료', 'Đã cài đặt/sửa 智能体 xong', 'Instalación/reparación de 智能体 completada', 'Instalação/reparo do 智能体 concluído', 'Установка/исправление 智能体 завершено', 'Installation/réparation 智能体 terminée', '智能体-Installation/Reparatur abgeschlossen'),
  fixBgTaskStarted: _('后台安装任务已启动，请等待完成...', 'Background install task started, please wait...', '後台安裝任務已啟動，請等待完成...'),
  fixOpenclawInstallFail: _('智能体 安装失败', '智能体 install failed', '智能体 安裝失敗', '智能体 インストール失敗', '智能体 설치 실패', 'Cài đặt 智能体 thất bại', 'Instalación de 智能体 fallida', 'Instalação do 智能体 falhou', 'Ошибка установки 智能体', 'Échec de l\'installation 智能体', '智能体-Installation fehlgeschlagen'),
  fixOpenclawOk: _('智能体 已安装', '智能体 installed', '智能体 已安裝', '智能体 インストール済み', '智能体 설치됨', '智能体 đã cài đặt', '智能体 instalado', '智能体 instalado', '智能体 установлен', '智能体 installé', '智能体 installiert'),
  fixCheckNode: _('检测 Node.js 安装状态...', 'Checking Node.js installation...', '檢測 Node.js 安裝狀態...', 'Node.js インストール状態を確認中...', 'Node.js 설치 상태 확인 중...', 'Kiểm tra cài đặt Node.js...', 'Comprobando instalación de Node.js...', 'Verificando instalação do Node.js...', 'Проверка установки Node.js...', 'Vérification de l\'installation Node.js...', 'Node.js-Installation wird überprüft...'),
  fixNodeNotInstalled: _('Node.js 未安装', 'Node.js not installed', 'Node.js 未安裝', 'Node.js 未インストール', 'Node.js 미설치', 'Node.js chưa cài đặt', 'Node.js no instalado', 'Node.js não instalado', 'Node.js не установлен', 'Node.js non installé', 'Node.js nicht installiert'),
  fixScanNodePaths: _('扫描系统 Node.js 路径...', 'Scanning system Node.js paths...', '掃描系統 Node.js 路徑...', 'システムの Node.js パスをスキャン中...', '시스템 Node.js 경로 검색 중...', 'Đang quét đường dẫn Node.js...', 'Escaneando rutas Node.js del sistema...', 'Verificando caminhos Node.js do sistema...', 'Поиск путей Node.js в системе...', 'Recherche des chemins Node.js dans le système...', 'Systemweite Node.js-Pfade werden gescannt...'),
  fixNodeFound: _('找到 Node.js', 'Found Node.js', '找到 Node.js', 'Node.js が見つかりました', 'Node.js 발견됨', 'Đã tìm thấy Node.js', 'Node.js encontrado', 'Node.js encontrado', 'Node.js найден', 'Node.js trouvé', 'Node.js gefunden'),
  fixNodePathSaved: _('Node.js 路径已保存', 'Node.js path saved', 'Node.js 路徑已儲存', 'Node.js パスを保存しました', 'Node.js 경로 저장됨', 'Đã lưu đường dẫn Node.js', 'Ruta Node.js guardada', 'Caminho Node.js salvo', 'Путь Node.js сохранён', 'Chemin Node.js enregistré', 'Node.js-Pfad gespeichert'),
  fixNodeNotFound: _('未找到系统中的 Node.js，请手动安装', 'Node.js not found, please install manually', '未找到系統中的 Node.js，請手動安裝', 'システムに Node.js が見つかりません。手動でインストールしてください', '시스템에서 Node.js를 찾을 수 없습니다. 수동으로 설치해 주세요', 'Không tìm thấy Node.js, vui lòng cài đặt thủ công', 'Node.js no encontrado, instale manualmente', 'Node.js não encontrado, instale manualmente', 'Node.js не найден, установите вручную', 'Node.js introuvable, veuillez installer manuellement', 'Node.js nicht gefunden, bitte manuell installieren'),
  fixNodeInstalling: _('正在自动安装 Node.js...', 'Installing Node.js automatically...', '正在自動安裝 Node.js...', 'Node.js を自動インストール中...', 'Node.js 자동 설치 중...', 'Đang tự động cài đặt Node.js...', 'Instalando Node.js automáticamente...', 'Instalando Node.js automaticamente...', 'Автоматическая установка Node.js...', 'Installation automatique de Node.js...', 'Node.js wird automatisch installiert...'),
  fixNodeInstallDone: _('Node.js 安装完成，请重启应用生效', 'Node.js installed, please restart the app', 'Node.js 安裝完成，請重啟應用生效', 'Node.js がインストールされました。アプリを再起動してください', 'Node.js 설치 완료, 앱을 재시작하세요', 'Đã cài đặt Node.js xong, hãy khởi động lại ứng dụng', 'Node.js instalado, reinicia la aplicación', 'Node.js instalado, reinicie o aplicativo', 'Node.js установлен, перезапустите приложение', 'Node.js installé, redémarrez l\'application', 'Node.js installiert, bitte App neu starten'),
  fixNodeInstallFail: _('Node.js 自动安装失败', 'Node.js auto-install failed', 'Node.js 自動安裝失敗', 'Node.js の自動インストールに失敗', 'Node.js 자동 설치 실패', 'Tự động cài đặt Node.js thất bại', 'Instalación automática de Node.js fallida', 'Instalação automática do Node.js falhou', 'Ошибка автоматической установки Node.js', 'Échec de l\'installation automatique de Node.js', 'Automatische Node.js-Installation fehlgeschlagen'),
  fixNodeInstallOffline: _('正在尝试离线安装...', 'Trying offline installation...', '正在嘗試離線安裝...', 'オフラインインストールを試みています...', '오프라인 설치 시도 중...', 'Đang thử cài đặt ngoại tuyến...', 'Intentando instalación sin conexión...', 'Tentando instalação offline...', 'Попытка установки без подключения...', 'Tentative d\'installation hors ligne...', 'Offline-Installation wird versucht...'),
  fixNodeInstallHint: _('请访问 https://nodejs.org 下载安装 Node.js，安装完成后重新打开应用', 'Please visit https://nodejs.org to install Node.js, then restart the app', '請訪問 https://nodejs.org 下載安裝 Node.js，安裝完成後重新開啟應用', 'https://nodejs.org から Node.js をインストールし、アプリを再起動してください', 'https://nodejs.org 에서 Node.js를 설치한 후 앱을 재시작하세요', 'Vui lòng truy cập https://nodejs.org để cài đặt Node.js, sau đó khởi động lại ứng dụng', 'Visita https://nodejs.org para instalar Node.js y reinicia la aplicación', 'Acesse https://nodejs.org para instalar Node.js e reinicie o aplicativo', 'Посетите https://nodejs.org для установки Node.js, затем перезапустите приложение', 'Visitez https://nodejs.org pour installer Node.js, puis redémarrez l\'application', 'Besuchen Sie https://nodejs.org um Node.js zu installieren, dann App neu starten'),
  fixNodeScanFail: _('扫描 Node.js 路径失败', 'Failed to scan Node.js paths', '掃描 Node.js 路徑失敗', 'Node.js パスのスキャンに失敗', 'Node.js 경로 검색 실패', 'Quét đường dẫn Node.js thất bại', 'Error al escanear rutas Node.js', 'Falha ao verificar caminhos Node.js', 'Ошибка поиска путей Node.js', 'Échec de la recherche des chemins Node.js', 'Fehler beim Scannen der Node.js-Pfade'),
  fixPairDone: _('设备配对完成', 'Device pairing done', '設備配對完成', 'デバイスペアリング完了', '기기 페어링 완료', 'Ghép đôi thiết bị xong', 'Emparejamiento de dispositivo completado', 'Emparelhamento de dispositivo concluído', 'Сопряжение устройства завершено', 'Jumelage de l\'appareil terminé', 'Gerätekopplung abgeschlossen'),
  fixPairFail: _('设备配对失败', 'Device pairing failed', '設備配對失敗', 'デバイスペアリング失敗', '기기 페어링 실패', 'Ghép đôi thiết bị thất bại', 'Emparejamiento de dispositivo fallido', 'Emparelhamento de dispositivo falhou', 'Ошибка сопряжения устройства', 'Échec du jumelage de l\'appareil', 'Gerätekopplung fehlgeschlagen'),
  fixDoctorDone: _('自动修复完成', 'Auto fix done', '自動修復完成', '自動修復完了', '자동 수리 완료', 'Sửa tự động xong', 'Reparación automática completada', 'Reparo automático concluído', 'Автоисправление завершено', 'Réparation automatique terminée', 'Automatische Reparatur abgeschlossen'),
  fixDoctorFail: _('自动修复失败', 'Auto fix failed', '自動修復失敗', '自動修復失敗', '자동 수리 실패', 'Sửa tự động thất bại', 'Reparación automática fallida', 'Reparo automático falhou', 'Ошибка автоисправления', 'Échec de la réparation automatique', 'Automatische Reparatur fehlgeschlagen'),
  fixGwRestarted: _('Gateway 已重启', 'Gateway restarted', 'Gateway 已重啟', 'Gateway が再起動しました', 'Gateway 재시작됨', 'Gateway đã khởi động lại', 'Gateway reiniciado', 'Gateway reiniciado', 'Gateway перезапущен', 'Gateway redémarré', 'Gateway neu gestartet'),
  fixGwForeign: _('Gateway 由外部进程管理', 'Gateway managed by external process', 'Gateway 由外部程序管理', 'Gateway は外部プロセスで管理されています', 'Gateway가 외부 프로세스에 의해 관리됨', 'Gateway được quản lý bởi tiến trình ngoài', 'Gateway gestionado por proceso externo', 'Gateway gerenciado por processo externo', 'Gateway управляется внешним процессом', 'Gateway géré par un processus externe', 'Gateway wird von externem Prozess verwaltet'),
  fixGwStarted: _('已启动', 'started', '已啟動', '起動済み', '시작됨', 'đã khởi động', 'iniciado', 'iniciado', 'запущен', 'démarré', 'gestartet'),
  fixGwTimeout: _('启动超时，可能仍在启动中', 'start timeout, may still be starting', '啟動逾時，可能仍在啟動中', '起動タイムアウト、まだ起動中かもしれません', '시작 타임아웃, 아직 시작 중일 수 있음', 'Hết thời gian khởi động, có thể vẫn đang khởi động', 'Tiempo de inicio agotado, puede seguir iniciando', 'Tempo de início esgotado, pode ainda estar iniciando', 'Тайм-аут запуска, возможно всё ещё запускается', 'Délai de démarrage dépassé, peut encore démarrer', 'Startzeit überschritten, möglicherweise noch am Starten'),
  fixWsTimeout: _('重连超时', 'reconnect timeout', '重連逾時', '再接続タイムアウト', '재연결 타임아웃', 'Hết thời gian kết nối lại', 'Tiempo de reconexión agotado', 'Tempo de reconexão esgotado', 'Тайм-аут повторного подключения', 'Délai de reconnexion dépassé', 'Zeitüberschreitung bei Wiederverbindung'),
}
