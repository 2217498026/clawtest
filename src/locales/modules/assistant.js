...
export default {
  ...
  skillCheckConfigDesc: _('检查 智能体 配置文件是否正确', 'Check if 智能体 config files are correct', '檢查 智能体 設定檔案是否正確'),
  ...
  skillBrowseDirDesc: _('浏览 智能体 配置目录结构', 'Browse 智能体 config directory structure', '瀏覽 智能体 設定目錄結構'),
  ...
  skillSkillsManagerDesc: _('管理 智能体 的 Skills', 'Manage 智能体 Skills'),
  // Hermes 专属 Skills
  ...
  qtcoolSyncTitle: _('同步到 智能体', 'Sync to 智能体'),
  qtcoolSyncDesc: _('将当前晴辰云配置同步到 智能体 全局配置', 'Sync current QingChen Cloud config to 智能体 global config', '將目前晴辰雲設定同步到 智能体 全域設定'),
  qtcoolSyncTo: _('同步到 智能体', 'Sync to 智能体'),
  qtcoolSyncToDesc: _('将晴辰云的 API 配置写入 智能体 全局配置文件', 'Write QingChen Cloud API config to 智能体 global config file', '將晴辰雲的 API 設定写入 智能体 全域設定檔案'),
  qtcoolSyncToTitle: _('确认同步到 智能体', 'Confirm sync to 智能体', '確認同步到 智能体'),
  qtcoolConfirmSync: _('将覆盖 智能体 中同名的 Provider，确定继续？', 'This will overwrite the same-name Provider in 智能体. Continue?', '將覆蓋 智能体 中同名的 Provider，確定繼續？'),
  qtcoolSyncToDone: _('已同步到 智能体', 'Synced to 智能体'),
  ...
  qtcoolSyncFrom: _('从 智能体 读取', 'Read from 智能体', '從 智能体 讀取'),
  qtcoolSyncFromTitle: _('确认从 智能体 读取', 'Confirm read from 智能体', '確認從 智能体 讀取'),
  qtcoolSyncFromDesc: _('将从 智能体 读取配置：\nBase URL: {baseUrl}\nAPI Key: {apiKey}\n模型: {model}', 'Will read config from 智能体:\nBase URL: {baseUrl}\nAPI Key: {apiKey}\nModel: {model}', '將從 智能体 讀取設定：\nBase URL: {baseUrl}\nAPI Key: {apiKey}\n模型: {model}'),
  qtcoolConfirmRead: _('确认读取', 'Confirm Read', '確認讀取'),
  qtcoolSyncFromDone: _('已从 智能体 读取配置', 'Read config from 智能体', '已從 智能体 讀取設定'),
  qtcoolReadFail: _('读取失败', 'Read failed', '讀取失敗'),
  qtcoolNoProvider: _('智能体 中没有找到晴辰云的配置', 'QingChen Cloud config not found in 智能体', '智能体 中沒有找到晴辰雲的設定'),
  ...
  personaOpenClaw: _('智能体 Agent', '智能体 Agent'),
  personaOpenClawHint: _('从 智能体 Agent 继承身份和工作区设置', 'Inherit identity and workspace from 智能体 Agent', '從 智能体 Agent 繼承身份和工作區設定', '智能体 Agent からIDとワークスペース設定を継承'),
  ...
  importBtn: _('导入 智能体 配置', 'Import 智能体 Config', '导入 智能体 設定'),
  importScanning: _('正在扫描本地 智能体 配置...', 'Scanning local 智能体 config...', '正在掃描本地 智能体 設定...'),
  ...
  guideDesc: _('，独立于 智能体，使用你在右上角「设置」中配置的 API。', ', independent of 智能体, using the API configured in Settings.', '，獨立於 智能体，使用你在右上角「設定」中設定的 API。'),
  guideHint: _('如需与 智能体 Agent 对话，请前往「实时聊天」页面。', 'To chat with 智能体 Agents, go to the Live Chat page.', '如需與 智能体 Agent 對話，請前往「實時聊天」頁面。'),
  ...
  inputHint: _('Enter 发送 · Shift+Enter 换行 · 支持粘贴/拖拽图片 · AI 助手独立于 智能体', 'Enter to send · Shift+Enter for newline · Paste/drag images · Independent of 智能体', 'Enter 發送 · Shift+Enter 換行 · 支援貼上/拖曳圖片 · AI 助手獨立於 智能体', 'Enter で送信 · Shift+Enter で改行 · 画像貼り付け/ドラッグ対応 · AI アシスタントは 智能体 とは独立'),
