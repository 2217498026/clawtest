...
export default {
  ...
  desc: _('管理已安装的 Skills，或从社区搜索安装新技能', 'Manage installed Skills or search and install new ones from the community', '管理已安裝的 Skills，或從社區搜尋安裝新技能', '智能体 Skills の管理とインストール', '智能体 Skills 관리 및 설치', 'Quản lý và cài đặt 智能体 Skills', 'Gestionar e instalar 智能体 Skills', 'Gerenciar e instalar 智能体 Skills', 'Управление и установка навыков 智能体', 'Gérer et installer les Skills 智能体', '智能体 Skills verwalten und installieren'),
  ...
  loadFailedHint: _('请确认 智能体 已安装并可用', 'Please confirm 智能体 is installed and available', '請確認 智能体 已安裝並可用'),
  retry: _('重试', 'Retry', '重試'),
  ...
  noSkillsHint: _('请确认 智能体 已正确安装。Skills 随 智能体 捆绑提供；自定义 Skills 可能位于 <code>~/.openclaw/skills/</code> 或 <code>~/.claude/skills/</code>。', 'Please confirm 智能体 is properly installed. Skills are bundled with 智能体; custom Skills may be in <code>~/.openclaw/skills/</code> or <code>~/.claude/skills/</code>.', '請確認 智能体 已正確安裝。Skills 隨 智能体 捆綁提供；自定義 Skills 可能位於 <code>~/.openclaw/skills/</code> 或 <code>~/.claude/skills/</code>。'),
