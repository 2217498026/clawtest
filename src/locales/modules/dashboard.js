...
export default {
  ...
  desc: _('智能体 运行状态概览', '智能体 runtime status overview', '智能体 執行狀態概覽', '智能体 実行状況の概要', '智能体 실행 상태 개요', 'Tổng quan trạng thái 智能体', 'Resumen del estado de 智能体', 'Visão geral do estado do 智能体', 'Обзор состояния 智能体', 'Vue d\'ensemble de l\'état 智能体', '智能体-Statusübersicht'),
  ...
  controlUIDesc: _('智能体 原生面板', '智能体 native panel', '', '智能体 ネイティブパネル', '智能体 네이티브 패널'),
  ...
  multiInstallCardHint: _('检测到多个安装，建议确认当前绑定的 CLI 与 智能体 目录。', 'Multiple installations detected. Confirm the bound CLI and 智能体 directory first.', '檢測到多個安裝，建議先確認目前綁定的 CLI 與 智能体 目錄。', '複数のインストールが検出されました。まず CLI バインドと 智能体 ディレクトリを確認してください。', '여러 설치가 감지되었습니다. 먼저 바인딩된 CLI와 智能体 디렉터리를 확인하세요.'),
  ...
  runtimeMetaLive: _('智能体 运行时', '智能体 runtime', '智能体 執行時', '智能体 ランタイム', '智能体 런타임'),
  ...
  startingGateway: _('正在启动 Gateway...', 'Starting Gateway...', '正在啟動 Gateway...', 'Gateway を起動中...', 'Gateway 시작 중...'),
  ...
  stoppingGateway: _('正在停止 Gateway...', 'Stopping Gateway...', '正在停止 Gateway...', 'Gateway を停止中...', 'Gateway 중지 중...'),
  restartingGateway: _('正在重启 Gateway...', 'Restarting Gateway...', '正在重啟 Gateway...', 'Gateway を再起動中...', 'Gateway 재시작 중...'),
