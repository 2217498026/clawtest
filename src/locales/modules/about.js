...
export default {
  ...
  subtitle: _('智能体 可视化管理面板', '智能体 Visual Management Panel', '', '智能体 ビジュアル管理パネル', '智能体 비주얼 관리 패널', 'Bảng quản lý trực quan 智能体', 'Panel de gestión visual de 智能体', 'Painel de gestão visual do 智能体', 'Панель визуального управления 智能体', 'Panneau de gestion visuelle 智能体', '智能体 Visuelles Verwaltungspanel'),
  ...
  installOpenclaw: _('安装 智能体', 'Install 智能体', '安裝 智能体', '智能体 をインストール', '智能体 설치'),
  ...
  confirmUninstall: _('确定要卸载 智能体 吗？\n\n这将停止 Gateway 服务并卸载 npm 全局包。\n配置文件（~/.openclaw/）默认保留，可稍后手动删除。', 'Are you sure you want to uninstall 智能体?\n\nThis will stop the Gateway service and uninstall the npm global package.\nConfig files (~/.openclaw/) are kept by default and can be deleted manually later.', '確定要卸載 智能体 吗？\n\n这將停止 Gateway 服務並卸載 npm 全域包。\n設定檔案（~/.openclaw/）預設保留，可稍后手動刪除。'),
  uninstallTitle: _('卸载 智能体', 'Uninstall 智能体', '卸載 智能体'),
  uninstallStarting: _('开始卸载 智能体...', 'Starting 智能体 uninstall...', '開始卸載 智能体...'),
  ...
  checkUpdateFailed: _('暂无法检查更新', 'Unable to check for updates', '暫無法檢查更新', '更新を確認できません', '업데이트 확인 실패', 'Kiểm tra cập nhật thất bại', 'Error al verificar actualizaciones', 'Falha ao verificar atualizações', 'Проверка обновлений', 'Vérification des mises à jour', 'Update-Prüfung fehlgeschlagen'),
  ...
  communityWelcome: _('欢迎加入 智能体 社区！遇到问题随时反馈，一起让 AI Agent 更好用。', 'Welcome to the 智能体 community! Report issues anytime, let\'s make AI Agents better together.', '歡迎加入 智能体 社群！遇到問題隨時反饋，一起讓 AI Agent 更好用。', '智能体 コミュニティへようこそ！問題があればいつでもフィードバックしてください。一緒に AI Agent をより使いやすくしましょう。', '智能体 커뮤니티에 오신 것을 환영합니다! 문제가 있으면 언제든 피드백해 주세요. 함께 AI Agent를 더 좋게 만들어요.', 'Chào mừng bạn đến với cộng đồng 智能体! Hãy phản hồi bất cứ lúc nào, cùng nhau làm cho AI Agent tốt hơn.', '¡Bienvenido a la comunidad 智能体! Reporta problemas en cualquier momento, hagamos juntos que los AI Agents sean mejores.', 'Bem-vindo à comunidade 智能体! Reporte problemas a qualquer momento, vamos juntos tornar os AI Agents melhores.', 'Добро пожаловать в сообщество 智能体! Сообщайте о проблемах в любое время, давайте вместе сделаем AI-агентов лучше.', 'Bienvenue dans la communauté 智能体 ! Signalez les problèmes à tout moment, construisons ensemble de meilleurs agents IA.', 'Willkommen in der 智能体-Community! Melden Sie Probleme jederzeit, lassen Sie uns gemeinsam AI-Agenten verbessern.'),
  communityWelcomeIntl: _('Welcome to the 智能体 community! Share ideas, get help, and build amazing AI agents together.', 'Welcome to the 智能体 community! Share ideas, get help, and build amazing AI agents together.'),
  ...
  projectOpenClawZh: _('我们维护的 智能体 汉化版，3000+ Star，中文界面 + 国内镜像优化', 'Our maintained Chinese translation of 智能体, 3000+ Stars, Chinese UI + domestic mirror optimization', '我們维护的 智能体 漢化版，3000+ Star，中文界面 + 國內鏡像最佳化'),
  projectClawPanel: _('智能体 可视化管理面板，Tauri v2 桌面应用', '智能体 visual management panel, Tauri v2 desktop app', '智能体 可视化管理面板，Tauri v2 桌面應用'),
  ...
  linkOpenClawZh: _('智能体 中文翻译', '智能体 Chinese Translation'),
  ...
  companyDesc: _('我们是 智能体 汉化版（3000+ Star）和 ClawPanel 的作者团队。日常做 AI Agent 相关的产品和开源工具，也接企业私有化部署、定制开发之类的活儿。有事直接群里找我们就行。', 'We are the team behind 智能体 Chinese Translation (3000+ Stars) and ClawPanel. We build AI Agent products and open source tools, and offer enterprise deployment and custom development services.', '我們是 智能体 漢化版（3000+ Star）和 ClawPanel 的作者團队。日常做 AI Agent 相關的產品和開源工具，也接企業私有化部署、定制開發之類的活儿。有事直接群里找我們就行。'),
